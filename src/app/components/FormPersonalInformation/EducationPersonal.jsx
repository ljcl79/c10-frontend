    ...
    <form onSubmit={handleSubmit} className="form__education">
     ...
     className="select__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg "
      ...
      <label htmlFor="course1">
        Nombre de la carrera, curso, bootcamp o certificación 1: <span className="asterisco">*</span>
      </label>
      <input id="course1" name="" type="text" onChange={handleInputChange} required className="input__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg" />
      <label htmlFor="institution1">Nombre institución 1:<span className="asterisco">*</span></label>
      <input id="institution1" name="" type="text" onChange={handleInputChange} required className="input__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg" />
      <label htmlFor="type1">Tipo institución 1:<span className="asterisco">*</span></label>
          <select
          className="select__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg"
            id="type1"
            name="type1"
      ...
      <input id="course2" name="" type="text" onChange={handleInputChange} className="input__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg"  />
      <label htmlFor="institution2">Nombre institución 2:</label>
      <input id="institution2" name="" type="text" onChange={handleInputChange} className="input__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg" />
      <label htmlFor="type2">Tipo institución 2:</label>
          ...
          <label >
            ¿Cual es tu situacion eduacional actual(Bootcamp, universidad, diplomado, cursos u otros)
            <select name="" id="" required className="select__info relative border bg-sky-100 h-12 w-64 top-0 left-0 border-solid border-#140b34  rounded-lg">
              ...
              <option value="Estudios tecnicos o universitarios en otras areas">Estudios tecnicos o universitarios en otras areas</option>
            </select>
          </label>
          <label required>
            <p>Nivel de ingles</p>
